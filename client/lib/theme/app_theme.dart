...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF2721B5),
      surfaceTint: Color(0xFF2721B5),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFF7771ff),
      onPrimaryContainer: Color(0xFF00008d),
      secondary: Color(0xFF65F6B7),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFb5ffff),
      onSecondaryContainer: Color(0xFF3dce8f),
      tertiary: Color(0xFF03CCFB),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF53ffff),
      onTertiaryContainer: Color(0xFF00a4d3),
      ...
      inversePrimary: Color(0xFF130da1),
      primaryFixed: Color(0xFF7771ff),
      onPrimaryFixed: Color(0xFF000079),
      primaryFixedDim: Color(0xFF635df1),
      onPrimaryFixedVariant: Color(0xFF130da1),
      secondaryFixed: Color(0xFFb5ffff),
      onSecondaryFixed: Color(0xFF29ba7b),
      secondaryFixedDim: Color(0xFFa1fff3),
      onSecondaryFixedVariant: Color(0xFF51e2a3),
      tertiaryFixed: Color(0xFF53ffff),
      onTertiaryFixed: Color(0xFF0090bf),
      tertiaryFixedDim: Color(0xFF3fffff),
      onTertiaryFixedVariant: Color(0xFF00b8e7),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF130da1),
      surfaceTint: Color(0xFF130da1),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFF000079),
      onPrimaryContainer: Color(0xFFFFFFFF),
      secondary: Color(0xFF51e2a3),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFF29ba7b),
      onSecondaryContainer: Color(0xFF000000),
      tertiary: Color(0xFF00b8e7),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF0090bf),
      ...
      inversePrimary: Color(0xFF2721B5),
      primaryFixed: Color(0xFF7771ff),
      onPrimaryFixed: Color(0xFF000079),
      primaryFixedDim: Color(0xFF635df1),
      onPrimaryFixedVariant: Color(0xFF130da1),
